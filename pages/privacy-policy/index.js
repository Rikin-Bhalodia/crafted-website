  ...
  return (
    <PrivacyPolicyWrapper>
      <div className="heading">
        Privacy Policy for Crafted Neem Tree Pvt. Ltd.
      </div>
      <p>
        At The Crafted , accessible from{" "}
        <Link href="https://www.thecrafted.in/">
          https://www.thecrafted.in/,
        </Link>{" "}
        one of our main priorities is the privacy of our visitors. This Privacy
        Policy document contains types of information that is collected and
        recorded by The Crafted and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in The Crafted . This policy is not applicable to
      ...
      <p>
        The Crafted follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, The Crafted uses 'cookies'. These cookies are
      ...
      <div>Google DoubleClick DART Cookie</div>
      ...
      <div>Advertising Partners Privacy Policies</div>

      <p>
        You may consult this list to find the Privacy Policy for each of the
        advertising partners of The Crafted .
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on The Crafted , which are sent
      ...
      <p>
        Note that The Crafted has no access to or control over these cookies
      ...
      <p>
        The Crafted 's Privacy Policy does not apply to other advertisers or
      ...
      <div>CCPA Privacy Rights (Do Not Sell My Personal Information)</div>
      ...
      <p>
        The Crafted does not knowingly collect any Personal Identifiable
